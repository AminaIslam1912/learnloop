...
//           .from('course')
//           .select('articles, tutorials, thumbnail_image, description')
...
//   }
//
//   Widget _buildContentSection(String? content, bool hasValidLink) {
//     return Column(
//       children: [
//         Container(
...
//                 children: [
//                   if (hasValidLink && thumbnailImage != null) ...[
//                     Container(
...
//                     Text(
//                       courseDescription ??
//                           "Course description not available at the moment.",
//                       style: const TextStyle(
//                         fontSize: 16,
...
//             child: _buildContentSection(articles, hasValidArticleLink),
//           ),
//           SingleChildScrollView(
//             padding: const EdgeInsets.symmetric(vertical: 16),
//             child: _buildContentSection(tutorials, hasValidTutorialLink),
//           ),
//         ],
//       ),
//     );
