...
//         options: ['I will go to school.', 'I go to school.', 'I went to school.'],
//         correctOptionIndex: 0,
//       ),
//       Question(
...
//     setState(() {
//       if (selectedIndex == categories[widget.categoryIndex].questions[currentQuestionIndex].correctOptionIndex) {
//         score++;
//       } else {
//         showAnswer = true;
//       }
...
//     setState(() {
//       showAnswer = false;
//       if (currentQuestionIndex < categories[widget.categoryIndex].questions.length - 1) {
...
//           content: Text('Your final score is $score/${categories[widget.categoryIndex].questions.length}'),
//           actions: <Widget>[
//             TextButton(
...
//   @override
//   Widget build(BuildContext context) {
//     Question currentQuestion = categories[widget.categoryIndex].questions[currentQuestionIndex];
//
//     return Scaffold(
//       appBar: AppBar(
...
//               child: Text(currentQuestionIndex < categories[widget.categoryIndex].questions.length - 1
//                   ? 'Next Question'
//                   : 'Finish Quiz'),
//             ),
//           ],
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // const Spacer(),
            const SizedBox(height: 20), // Replaces Spacer for better control
            Center(
              child: ElevatedButton(
                onPressed: nextQuestion,
                child: Text(
                  currentQuestionIndex <
                      ...
                      ? 'Next Question'
                      : 'Finish Quiz',
                  style: const TextStyle(color: Colors.green), // Corrected here
                ),
              ),
            ),
          ],
