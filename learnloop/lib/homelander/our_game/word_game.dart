...
//   final List<String> easyWords = ['apple', 'chair', 'table', 'bread', 'plant','python','phone', 'free', 'mother', 'father'];
//   final List<String> mediumWords = ['puzzle', 'garden', 'butter', 'orange', 'purple', 'brother', 'sister', 'date', 'desert', 'life'];
//   final List<String> hardWords = ['elephant', 'scramble', 'airplane', 'sunflower', 'computer','examination','palestine', 'bangladesh', 'bicycle'];
//
