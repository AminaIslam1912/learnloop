...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<bool> _sendOTPToEmail(String email, int otp) async {
    const String senderEmail = 'kawserabu11mini@gmail.com';
    const String senderName = 'learnloop';
    const String apiKey = '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';
    //const String apiKey = '';
              ...
              children: [
                ...
                Center(
                  child: Row(
                    ...
                    children: [
                      Flexible( // Wrap the "Don't have an account?" text with Flexible
                        child: TextButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                      ...
                      const SizedBox(width: 1), // Add some space between the two buttons
                      TextButton(
                        onPressed: _showForgotPasswordDialog,
                        child: const Text(
                          'Forgot Password?',
